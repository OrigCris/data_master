...
| `dm create-cluster` | Cria/reutiliza um cluster all-purpose (SINGLE_USER, autotermination curto) e imprime o `cluster_id`, para trabalho interativo/ad-hoc. Os jobs dos bundles usam **job cluster** próprio. |
