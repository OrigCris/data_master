...
> Plataforma de engenharia de dados **end-to-end**, orientada a eventos e
> serverless, sobre **Microsoft Azure** com arquitetura **Medallion** em **Azure
> Databricks**. Domínio: **call center / URA**. Desenvolvido para o programa Data
> Master.
...
- **Ingestão em tempo real** com Azure Functions (SPN/Key Vault) → **Event Hubs**
- **Processamento incremental** em camadas `bronze → silver → gold` com **Delta +
  Change Data Feed + MERGE idempotente**
...
- ✅ **Testes** unitários (pytest) rodando no CI sem cluster Spark
- ✅ **Lint** (ruff) e **validação de bundles/Bicep** no CI
